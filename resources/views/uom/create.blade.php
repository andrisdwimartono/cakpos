                ...
                @csrf
                    <div class="card-body">
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="uom_name">Nama</label>
                                <div class="col-sm-6">
                                    <input type="text" name="uom_name" class="form-control" id="uom_name" placeholder="Enter Nama" @if($page_data["page_method_name"] == "View") readonly @endif>
                                </div>
                            </div>
                        <div class="form-group row">
